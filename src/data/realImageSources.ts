...
import openverseImageSources from "./openverseImageSources.json";
...
const unsplashTrainingImages: RealTrainingImage[] = [
  ...
  makeUnsplashImage({
    id: "unsplash-turkey-ankara-street-road-sign",
    file: "turkey-ankara-street-road-sign.jpg",
    photoId: "4x9QbTU-7hU",
    title: "Turkey Ankara street road sign",
    country: "Turkey",
    tags: ["turkey", "turkish", "road-signs", "street-signs", "language"],
    matchTags: ["turkey", "turkish", "ankara", "road-signs", "street-signs"],
    priority: 92,
  }),
  makeUnsplashImage({
    id: "unsplash-turkey-palm-street-road-sign",
    file: "turkey-palm-street-road-sign.jpg",
    photoId: "WbKQhd-wHbM",
    title: "Turkey palm street road sign",
    country: "Turkey",
    tags: ["turkey", "turkish", "road-signs", "street-signs", "language"],
    matchTags: ["turkey", "turkish", "road-signs", "street-signs", "urban"],
    priority: 90,
  }),
  makeUnsplashImage({
    id: "unsplash-turkey-istanbul-metro-street-sign",
    file: "turkey-istanbul-metro-street-sign.jpg",
    photoId: "URZvIea05RQ",
    title: "Turkey Istanbul metro street sign",
    country: "Turkey",
    tags: ["turkey", "turkish", "street-signs", "transit", "language"],
    matchTags: ["turkey", "turkish", "istanbul", "metro", "street-signs"],
    priority: 91,
  }),
  makeUnsplashImage({
    id: "unsplash-turkey-istanbul-car-road-sign",
    file: "turkey-istanbul-car-road-sign.jpg",
    photoId: "zp8CKm8YPJ8",
    title: "Turkey Istanbul road sign",
    country: "Turkey",
    tags: ["turkey", "turkish", "road-signs", "urban", "language"],
    matchTags: ["turkey", "turkish", "istanbul", "road-signs", "urban"],
    priority: 89,
  }),
  makeUnsplashImage({
    id: "unsplash-turkey-istanbul-architecture-street-sign",
    file: "turkey-istanbul-architecture-street-sign.jpg",
    photoId: "-WPFN-2wiN8",
    title: "Turkey Istanbul architecture street sign",
    country: "Turkey",
    tags: ["turkey", "turkish", "architecture", "street-signs", "urban"],
    matchTags: ["turkey", "turkish", "istanbul", "architecture", "street-signs"],
    priority: 88,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-highway-street-sign",
    file: "south-africa-highway-street-sign.jpg",
    photoId: "nNCVNuEETXs",
    title: "South Africa highway street sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "highway", "left-driving", "southern-africa"],
    matchTags: ["south-africa", "south africa", "road-signs", "highway", "left-driving"],
    priority: 93,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-speed-limit-road-sign",
    file: "south-africa-speed-limit-road-sign.jpg",
    photoId: "79LNxO2lN6k",
    title: "South Africa speed limit road sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "speed-limit", "left-driving", "southern-africa"],
    matchTags: ["south-africa", "south africa", "speed-limit", "road-signs", "left-driving"],
    priority: 92,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-pretoria-street-sign",
    file: "south-africa-pretoria-street-sign.jpg",
    photoId: "PFH1_WElGB8",
    title: "South Africa Pretoria street sign",
    country: "South Africa",
    tags: ["south-africa", "street-signs", "urban", "language", "southern-africa"],
    matchTags: ["south-africa", "south africa", "pretoria", "street-signs", "urban"],
    priority: 91,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-johannesburg-road-sign",
    file: "south-africa-johannesburg-road-sign.jpg",
    photoId: "oNP1rrzkM6E",
    title: "South Africa Johannesburg road sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "urban", "left-driving", "southern-africa"],
    matchTags: ["south-africa", "south africa", "johannesburg", "road-signs", "urban"],
    priority: 90,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-midrand-street-sign",
    file: "south-africa-midrand-street-sign.jpg",
    photoId: "gKSRbzk4I_4",
    title: "South Africa Midrand street sign",
    country: "South Africa",
    tags: ["south-africa", "street-signs", "urban", "southern-africa"],
    matchTags: ["south-africa", "south africa", "midrand", "street-signs", "urban"],
    priority: 88,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-agulhas-road-sign",
    file: "south-africa-agulhas-road-sign.jpg",
    photoId: "yHJy4qJxTw4",
    title: "South Africa Agulhas road sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "coastal", "southern-africa"],
    matchTags: ["south-africa", "south africa", "agulhas", "road-signs", "coastal"],
    priority: 89,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-sandton-road-sign",
    file: "south-africa-sandton-road-sign.jpg",
    photoId: "59fcwANAhWM",
    title: "South Africa Sandton road sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "urban", "southern-africa"],
    matchTags: ["south-africa", "south africa", "sandton", "road-signs", "urban"],
    priority: 88,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-durban-no-right-turn",
    file: "south-africa-durban-no-right-turn.jpg",
    photoId: "8yNt8jJIfds",
    title: "South Africa Durban no-right-turn sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "traffic-signs", "urban", "southern-africa"],
    matchTags: ["south-africa", "south africa", "durban", "road-signs", "traffic-signs"],
    priority: 87,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-robben-island-warning-sign",
    file: "south-africa-robben-island-warning-sign.jpg",
    photoId: "gbJAejsWnZ4",
    title: "South Africa Robben Island warning sign",
    country: "South Africa",
    tags: ["south-africa", "warning-signs", "coastal", "southern-africa"],
    matchTags: ["south-africa", "south africa", "robben-island", "warning-signs", "coastal"],
    priority: 86,
  }),
  makeUnsplashImage({
    id: "unsplash-south-africa-cape-town-rail-road-sign",
    file: "south-africa-cape-town-rail-road-sign.jpg",
    photoId: "-2jo2UJMjOI",
    title: "South Africa Cape Town rail road sign",
    country: "South Africa",
    tags: ["south-africa", "road-signs", "rail-crossing", "urban", "southern-africa"],
    matchTags: ["south-africa", "south africa", "cape-town", "road-signs", "rail-crossing"],
    priority: 87,
  }),
  makeUnsplashImage({
    id: "unsplash-kenya-turkana-road-sign",
    file: "kenya-turkana-road-sign.jpg",
    photoId: "RpThnX9H5VE",
    title: "Kenya Turkana road sign",
    country: "Kenya",
    tags: ["kenya", "road-signs", "east-africa", "left-driving", "landscape"],
    matchTags: ["kenya", "kenyan", "turkana", "road-signs", "east-africa"],
    priority: 92,
  }),
  makeUnsplashImage({
    id: "unsplash-nigeria-abuja-street-sign",
    file: "nigeria-abuja-street-sign.jpg",
    photoId: "uM1mxUEmesA",
    title: "Nigeria Abuja street sign",
    country: "Nigeria",
    tags: ["nigeria", "street-signs", "west-africa", "english", "urban"],
    matchTags: ["nigeria", "nigerian", "abuja", "street-signs", "west-africa"],
    priority: 92,
  }),
];

const openverseTrainingImages = openverseImageSources as RealTrainingImage[];
